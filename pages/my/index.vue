<template>
	<view>
		...
		<view class="box">
			<navigator url='../address/index' class='item'>
				<view class="item_t">
					<image src='/static/images/m_address.png' mode='widthFix'></image>
				</view>
				<view class="item_z">服务地址</view>
			</navigator>
			<navigator url='feedback' class='item'>
				<view class="item_t">
					<image src="/static/images/m_feedback.png" mode="widthFix"></image>
				</view>
				<view class="item_z">意见反馈</view>
			</navigator>
			<view bindtap="callPhone" data-tel="18659608055" class='item'>
				<view class="item_t">
					<image src='/static/images/m_tel.png' mode='widthFix'></image>
				</view>
				<view class="item_z">联系电话</view>
			</view>
			<button openType="contact" class='item contact'>
				<view class="item_t">
					<image src='/static/images/m_kefu.png' mode='widthFix'></image>
				</view>
				<view class="item_z">联系客服</view>
			</button>
		</view>
	...
	export default {
		...
		onShow() {
			...
			if (this.user_info) {
				...
				this.name = app.globalData.user_info.storeName;
